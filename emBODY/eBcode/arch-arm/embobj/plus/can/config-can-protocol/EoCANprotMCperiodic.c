...
//    }
//    
//    motor = eoprot_entity_ramof_get(eoprot_board_localboard, eoprot_endpoint_motioncontrol, eoprot_entity_mc_motor, index);
//    
//    if(NULL != mindex)
//    {
//        *mindex = index;        
...
//    }
//    
//    joint = eoprot_entity_ramof_get(eoprot_board_localboard, eoprot_endpoint_motioncontrol, eoprot_entity_mc_joint, index);
//    
//    if(NULL != jindex)
//    {
//        *jindex = index;        
...
//    
//    eOmc_motor_t *motor = eoprot_entity_ramof_get(eoprot_board_localboard, eoprot_endpoint_motioncontrol, eoprot_entity_mc_motor, motorindex);
//    
//    if(NULL == motor)
//    {
//        /////#warning -> TODO: add diagnostics about not found board as in s_eo_icubCanProto_mb_send_runtime_error_diagnostics()
