...
#define EOMTHEEMSAPPLCFG_ID_OF_EMSBOARD     9
    ...
    //#warning --> compiling using extDefEmsBoardNum.h
    #include "extDefEmsBoardNum.h" // this file, if not existing, it is generated by script thats creates executables for all boards
#endif
